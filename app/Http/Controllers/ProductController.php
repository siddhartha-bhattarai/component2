...
use App\Awe\BookProduct;
use App\Awe\CdProduct;
...
class ProductController extends Controller
{
    public static function makeProductArray() {
        ...
        foreach ($productsJson as $product) {
            switch($product['type']) {
                ...
                case "shop":
                    $bookproduct = new BookProduct($product['id'],$product['title'],  $product['firstname'],
                        $product['mainname'],$product['price']);
                    $books[]=$bookproduct;
                    break;
            }
        }
    ...
    public static function deleteProductWithId() {
        $file = '../public/products.json';
        $string = file_get_contents($file);
    ...
    public static function getProductWithId() {
        $file = '../public/products.json';
        $string = file_get_contents($file);
    ...
    public static function updateProductWithId()
    {
        $file ='../public/products.json';
        $string = file_get_contents($file);
        $products= [];
